...
on STEP 1 (a restart, a new dict key, a rebuilt library) is checked at START-UP + 1-2 STEPS **for that
bed** (coarse 81k ~20-30 s, 449k ~60-90 s) — never one constant; a failure RATE at
